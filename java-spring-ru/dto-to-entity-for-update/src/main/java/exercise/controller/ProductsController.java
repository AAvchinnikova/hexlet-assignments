...
public class ProductsController {
    ...
    public ProductDTO update(@PathVariable long id, @RequestBody ProductUpdateDTO productUpdate) {
        ...
        toEntityUpdate(productUpdate, maybeproduct);
        productRepository.save(maybeproduct);
        var productDTO = toDTO(maybeproduct);
        return productDTO;
    }

    private Product toEntityUpdate(ProductUpdateDTO productUpdate, Product product) {
